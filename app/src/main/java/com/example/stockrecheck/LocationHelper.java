...
public class LocationHelper {
    ...
    public static Map<String, Map<String,String>> mapStorage = new HashMap<String, Map<String,String>>();
//    public static ArrayList<String> hashMap = new ArrayList<>();

    public static ArrayList<String> MemberList = new ArrayList<>();

    public static List<Map<String, String>> seclist  = new ArrayList<Map<String, String>>();
    List<Map<String, String>> hnlist  = new ArrayList<Map<String, String>>();

    public static String arrStorge[] ;

    public static ArrayList<String> secs = new ArrayList<String>();
